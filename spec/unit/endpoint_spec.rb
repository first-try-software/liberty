RSpec.describe Liberty::Endpoint do
  ...
  describe '#status' do
    ...
    context 'when the endpoint class implement #status' do
      let(:endpoint_class) { Class.new(described_class) { def status; 420; end } }
  ...
  describe '#headers' do
    ...
    context 'when the endpoint class implement #headers' do
      let(:endpoint_class) { Class.new(described_class) { def headers; { 'Header' => 'value' }; end } }
  ...
  describe '#json' do
    ...
    context 'when the endpoint class implements #json' do
      let(:endpoint_class) { Class.new(described_class) { def json; { key: 'value' }; end } }
  ...
  describe '#html' do
    ...
    context 'when the endpoint class implements #html' do
      let(:endpoint_class) { Class.new(described_class) { def html; '<html><body>FREEDOM!</body></html>'; end } }
  ...
  describe '#text' do
    ...
    context 'when the endpoint class implements #text' do
      let(:endpoint_class) { Class.new(described_class) { def text; 'FREEDOM!'; end } }
  ...
  describe '#body' do
    ...
    context 'when the endpoint class implements #body' do
      let(:endpoint_class) { Class.new(described_class) { def body; 'FREEDOM!'; end } }
